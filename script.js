...
import { updateObstacle2, setupObstacle2, getObstacle2Rects } from "./obstacle2.js"
import { updateNft, setupNft, getNftRects } from "./nft.js"

const GAME_WIDTH = 100
const GAME_HEIGHT = 35
const SPEED_SCALE_INCREASE = 0.000017
...
function update(time) {
  ...
  updateObstacle2(delta, speedScale)
...
function checkLose() {
  ...
  return (getObstacleRects().some(rect => isCollision(rect, playerRect)) || getObstacle2Rects().some(rect => isCollision(rect, playerRect)))
}
